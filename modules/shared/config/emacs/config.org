...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Daniel Heppner"
    user-mail-address "dh@danielheppner.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/danielhep/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/danielhep/bin" "/profile/bin" "/Users/danielhep/.npm-packages/bin" "/Users/danielhep/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
